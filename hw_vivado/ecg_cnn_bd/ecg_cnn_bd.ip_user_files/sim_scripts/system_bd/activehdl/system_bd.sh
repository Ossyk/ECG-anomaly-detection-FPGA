...
#                script (type 'system_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/oussk/Downloads/ald_v2/hw_vivado/ecg_cnn_bd/ecg_cnn_bd.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
