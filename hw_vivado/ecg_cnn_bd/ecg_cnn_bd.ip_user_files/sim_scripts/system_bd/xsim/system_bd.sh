...
#
# Script generated by Vivado on Thu Dec 11 00:36:03 +0100 2025
...
#
# Usage        : system_bd.sh
#                system_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_bd.sh [-reset_run]
#                system_bd.sh [-reset_log]
#                system_bd.sh [-help]
#
...
# script info
echo -e "system_bd.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
simulate()
{
  xsim system_bd -key {Behavioral:sim_1:Functional:system_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_e6ac.protoinst" -protoinst "protoinst_files/system_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_bd.wdb xsim.dir libdpi.so)
...
Usage: system_bd.sh [-step]\n\
Usage: system_bd.sh [-lib_map_path]\n\
Usage: system_bd.sh [-reset_run]\n\
Usage: system_bd.sh [-reset_log]\n\
Usage: system_bd.sh [-keep_index]\n\
