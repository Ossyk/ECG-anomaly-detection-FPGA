...
attribute shreg_extract : string;
    ...
    signal add_ln146_fu_425_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln146_reg_679 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal trunc_ln146_fu_431_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal trunc_ln146_reg_684 : STD_LOGIC_VECTOR (3 downto 0);
    signal acc_fu_436_p35 : STD_LOGIC_VECTOR (7 downto 0);
    signal acc_reg_690 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start : STD_LOGIC;
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_done : STD_LOGIC;
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_idle : STD_LOGIC;
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_ready : STD_LOGIC;
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_phi_ln150_out : STD_LOGIC_VECTOR (11 downto 0);
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_phi_ln150_out_ap_vld : STD_LOGIC;
    signal grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg : STD_LOGIC := '0';
    signal icmp_ln146_fu_419_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal u_fu_164 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal select_ln152_fu_522_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal acc_fu_436_p33 : STD_LOGIC_VECTOR (7 downto 0);
    signal acc_fu_436_p34 : STD_LOGIC_VECTOR (3 downto 0);
    signal icmp_ln152_fu_516_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln148_fu_512_p1 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component ecg_cnn_dense_relu_Pipeline_VITIS_LOOP_148_2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        sext_ln147 : IN STD_LOGIC_VECTOR (7 downto 0);
        ...
        input_14_val : IN STD_LOGIC_VECTOR (11 downto 0);
        input_15_val : IN STD_LOGIC_VECTOR (11 downto 0);
        phi_ln150_out : OUT STD_LOGIC_VECTOR (11 downto 0);
        phi_ln150_out_ap_vld : OUT STD_LOGIC );
    end component;
...
begin
    grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380 : component ecg_cnn_dense_relu_Pipeline_VITIS_LOOP_148_2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln146_fu_419_p2 = ap_const_lv1_0))) then 
                    grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_ready = ap_const_logic_1)) then 
                    grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_done, icmp_ln146_fu_419_p2, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln146_fu_419_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_done = ap_const_logic_1))) then
    ...
    add_ln146_fu_425_p2 <= std_logic_vector(unsigned(u_fu_164) + unsigned(ap_const_lv5_1));
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_done)
    begin
        if ((grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, icmp_ln146_fu_419_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln146_fu_419_p2 = ap_const_lv1_1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, icmp_ln146_fu_419_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln146_fu_419_p2 = ap_const_lv1_1))) then 
    ...
    grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start <= grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_ap_start_reg;
    icmp_ln146_fu_419_p2 <= "1" when (u_fu_164 = ap_const_lv5_10) else "0";
    icmp_ln152_fu_516_p2 <= "1" when (signed(grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_phi_ln150_out) > signed(ap_const_lv12_0)) else "0";
    output_0 <= select_ln152_fu_522_p3;

    output_0_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_0))) then 
    ...
    output_1 <= select_ln152_fu_522_p3;
    output_10 <= select_ln152_fu_522_p3;

    output_10_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_A))) then 
    ...
    output_11 <= select_ln152_fu_522_p3;

    output_11_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_B))) then 
    ...
    output_12 <= select_ln152_fu_522_p3;

    output_12_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_C))) then 
    ...
    output_13 <= select_ln152_fu_522_p3;

    output_13_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_D))) then 
    ...
    output_14 <= select_ln152_fu_522_p3;

    output_14_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_E))) then 
    ...
    output_15 <= select_ln152_fu_522_p3;

    output_15_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_F))) then 
    ...
    output_1_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_1))) then 
    ...
    output_2 <= select_ln152_fu_522_p3;

    output_2_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_2))) then 
    ...
    output_3 <= select_ln152_fu_522_p3;

    output_3_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_3))) then 
    ...
    output_4 <= select_ln152_fu_522_p3;

    output_4_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_4))) then 
    ...
    output_5 <= select_ln152_fu_522_p3;

    output_5_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_5))) then 
    ...
    output_6 <= select_ln152_fu_522_p3;

    output_6_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_6))) then 
    ...
    output_7 <= select_ln152_fu_522_p3;

    output_7_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_7))) then 
    ...
    output_8 <= select_ln152_fu_522_p3;

    output_8_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_8))) then 
    ...
    output_9 <= select_ln152_fu_522_p3;

    output_9_ap_vld_assign_proc : process(trunc_ln146_reg_684, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (trunc_ln146_reg_684 = ap_const_lv4_9))) then 
    ...
    select_ln152_fu_522_p3 <= 
        trunc_ln148_fu_512_p1 when (icmp_ln152_fu_516_p2(0) = '1') else 
        ap_const_lv11_0;
    trunc_ln146_fu_431_p1 <= u_fu_164(4 - 1 downto 0);
    trunc_ln148_fu_512_p1 <= grp_dense_relu_Pipeline_VITIS_LOOP_148_2_fu_380_phi_ln150_out(11 - 1 downto 0);
end behav;
