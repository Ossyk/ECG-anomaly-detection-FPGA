...
HLS_SOURCES = ../../../../../testbench_ecg_cnn.cpp ../../../../../ecg_cnn.cpp
...
$(ObjDir)/testbench_ecg_cnn.o: ../../../../../testbench_ecg_cnn.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../testbench_ecg_cnn.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_ecg_cnn.d

$(ObjDir)/ecg_cnn.o: ../../../../../ecg_cnn.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../ecg_cnn.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ecg_cnn.d
