...
reg   [0:0] icmp_ln177_reg_506;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [0:0] icmp_ln177_fu_270_p2;
reg   [11:0] phi_ln179_fu_144;
wire    ap_block_pp0_stage1_11001;
reg   [11:0] ap_sig_allocacmp_phi_ln179_load;
wire    ap_block_pp0_stage1;
wire    ap_loop_init;
reg   [11:0] acc_01_fu_148;
wire    ap_block_pp0_stage0;
reg   [4:0] i_fu_152;
wire   [4:0] add_ln177_fu_276_p2;
reg   [4:0] ap_sig_allocacmp_i_3;
wire   [10:0] sext_ln_fu_286_p33;
wire   [3:0] trunc_ln177_fu_282_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln177_fu_270_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        phi_ln179_fu_144 <= 12'd0;
    end else if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        phi_ln179_fu_144 <= {{acc_fu_454_p1[20:9]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln177_reg_506 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ap_sig_allocacmp_phi_ln179_load = {{acc_fu_454_p1[20:9]}};
    end else begin
...
assign add_ln177_fu_276_p2 = (ap_sig_allocacmp_i_3 + 5'd1);
...
assign ap_return = ap_sig_allocacmp_phi_ln179_load;
...
assign icmp_ln177_fu_270_p2 = ((ap_sig_allocacmp_i_3 == 5'd16) ? 1'b1 : 1'b0);

assign sext_ln_fu_286_p33 = 'bx;

assign tmp_s_fu_362_p33 = 'bx;

assign trunc_ln177_fu_282_p1 = ap_sig_allocacmp_i_3[3:0];
