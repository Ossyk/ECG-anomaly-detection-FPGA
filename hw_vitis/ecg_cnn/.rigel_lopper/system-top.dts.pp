# 1 "C:\\Users\\oussk\\OneDrive\\Desktop\\ECG_CNN_PROJECT_ALD\\hw_vitis\\ecg_cnn\\ecg_platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\oussk\\OneDrive\\Desktop\\ECG_CNN_PROJECT_ALD\\hw_vitis\\ecg_cnn\\ecg_platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\oussk\\OneDrive\\Desktop\\ECG_CNN_PROJECT_ALD\\hw_vitis\\ecg_cnn\\ecg_platform\\hw\\sdt\\pl.dtsi" 1
/ {
 cpus_microblaze_0: cpus_microblaze@0 {
  ...
  microblaze_0: cpu@0 {
   ...
   xlnx,use-icache = <1>;
   d-cache-size = <8192>;
   xlnx,memory-ip-list = "microblaze_0_local_memory_ilmb_bram_if_cntlr_memory" , "microblaze_0_local_memory_dlmb_bram_if_cntlr_memory" , "axi_bram_ctrl_0_memory" , "axi_bram_ctrl_0_memory";
   xlnx,async-wakeup = <3>;
 ...
 amba_pl: amba_pl {
  ...
  axi_uartlite_0: serial@40610000 {
  ...
  ecg_cnn_0: ecg_cnn@80000000 {
   compatible = "xlnx,ecg-cnn-1.0";
   xlnx,ii = <60678>;
   xlnx,machine = <64>;
   xlnx,ip-name = "ecg_cnn";
...
# 3 "C:\\Users\\oussk\\OneDrive\\Desktop\\ECG_CNN_PROJECT_ALD\\hw_vitis\\ecg_cnn\\ecg_platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7a100t";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0xC0000000 &axi_bram_ctrl_0_memory 0xC0000000 0x10000>,
         <0xC0000000 &axi_bram_ctrl_0 0xC0000000 0x10000>,
         ...
         <0x40610000 &axi_uartlite_0 0x40610000 0x10000>,
         <0x80000000 &ecg_cnn_0 0x80000000 0x10000>;
